  ...
  <footer class="max-w-2xl mx-auto px-5 md:px-10 py-8 text-theme-text-tertiary flex flex-col lg:flex-row flex-wrap justify-between items-center">
    <div class="mb-4 lg:mb-0 text-center md:text-left">
      <span class="block md:inline-block mb-4 md:mb-0 text-center">&copy; <a
        ...
        target="_blank"
      >unik-name.com</a> | {{ year }}. {{ $t("All rights reserved") }}</span>
    ...
    <div class="text-center">
      ...
      <a
        href="https://twitter.com/UnikName_UNS"
        target="_blank"
      >
        <svg
          viewBox="0 0 24 24"
      ...
      <!--a
        href="https://www.youtube.com/channel/UC3ihIBgL8p0ux--IR4OIdwg"
        target="_blank"
      >
        <svg
          viewBox="0 0 24 24"
      ...
      <a
        href="https://github.com/unik-name"
        target="_blank"
      >
        <svg
          viewBox="0 0 24 24"
      ...
      <a
        href="https://medium.com/unik-name"
        target="_blank"
      >
        <svg
          viewBox="0 0 24 24"
      ...
      >
        <svg
          ...
          data-prefix="fab"
          data-icon="discourse"
          class="m-2 svg-inline--fa fa-discourse fa-w-14"
          role="img"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 448 512"
          width="16px"
...
export default {
  ...
  computed: {
    ...
    versionLink () {
      return `https://github.com/unik-name/explorer/commit/${GIT_VERSION}`
    },
    date () {
      return GIT_DATE
    }
