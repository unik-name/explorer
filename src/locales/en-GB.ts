...
export default {
  ...
  BLOCK: {
    ...
    TOTAL_REWARDS: "Total UNIK forged",
  },
  ...
  TRANSACTION: {
    ...
    TYPES: {
      ...
      SENT: "Sent",
      RECEIVED: "Received",
      UNIK_CREATION: "**UNIKNAME creation**",
      UNIK_UPDATE: "**UNIKNAME Update**",
      UNIK_TRANSFER: "UNIKNAME Transfer",
      ...
      UNS_CERTIFIED_NFT_MINT: "UNIKNAME Creation",
      UNS_CERTIFIED_NFT_MINT_INDIV: "Individual UNIKNAME Creation",
      UNS_CERTIFIED_NFT_MINT_ORG: "Organization UNIKNAME Creation",
      UNS_CERTIFIED_NFT_MINT_NETWORK: "Network UNIKNAME Creation",
      UNS_CERTIFIED_NFT_UPDATE: "UNIKNAME Update",
      UNKNOWN: "Unknown",
      UNS_VERIFY_URL: "URL verify",
      UNS_ALIVE_DEMAND: "UNIKNAME Activation",
    ...
    REWARDS: {
      SENDER: "UNIKNAME owner rewards",
      FOUNDATION: "unikname.network foundation rewards",
  ...
  SEARCH: {
    PLACEHOLDER: {
      SHORT: "Search",
      LONG: "Find a block, transaction, address or network player or UNIKNAME",
    },
  ...
  FOOTER: {
    ...
    VERSION: "Version",
    DATE: "Date",
    NETWORK: "unikname.network",
    FORUM: "Forum",
    DOCS: "Docs",
  },

  UNIK: {
    SUMMARY: "UNIKNAME summary",
    ID: "UNIKNAME ID",
    CREATION: "**UNIKNAME Creation**",
    CERTIFIED_CREATION: "UNIKNAME Creation",
    UPDATE: "**UNIKNAME Update**",
    CERTIFIED_UPDATE: "UNIKNAME Update",
    TRANSFER: "UNIKNAME Transfer",
    TRANSFER_TO: "UNIKNAME Transfer to",
    DISCLOSE: "UNIKNAME Disclose",
    OWNER: "Owner",
